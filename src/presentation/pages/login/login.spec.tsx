...
describe('Login Component', () => {
  ...
  test('Should enable suibmit button if form is valid', () => {
    const { sut } = makeSut()
    Helper.populateField(sut, 'email')
    Helper.populateField(sut, 'password')
  ...
  test('Should call SaveAccessToken on success', async () => {
    ...
    await simulateValidSubmit(sut)
    expect((saveAccessTokenMock as SaveAccessTokenMock).accessToken).toBe(authenticationSpy.account.accessToken)
